...
@section('meta-content')
  <title>Profile | {{ config('app.name') }} Admin Portal</title>
@endsection
@php
						...
						<div class="row">
							...
							<div class="col-12">
								<div class="form-group">
									...
									<input name="email" type="email" id="email_label" aria-describedby="emailHelp" disabled value="{{ $email }}" required>
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
									<label for="mobile_label" class="text-grey-darkest uppercase">Mobile Number <span class="required">*</span></label>
									<input name="phone_number" type="tel" id="mobile_label" value="{{ $phone_number }}" required>
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
