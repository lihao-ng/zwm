...
@section('meta-content')
  <title>Directors | {{ config('app.name') }} Admin Portal</title>
@endsection
  ...
  <div class="card bootstrap-table">
    <div class="card-body table-full-width">
      <div class="toolbar d-flex mb-3">
        <a href="{{ route('admin.directors.create') }}" class="ml-auto btn btn-primary">
          Create
        </a>
      ...
      <div class="table-responsive-sm custom-table">
        <table id="bootstrap-table" class="table"
          ...
          data-url="{{ route('admin.directors.index') }}"
          >
          <thead>
