...
@section('meta-content')
  <title>Edit Accepting Item</title>
@endsection

@section('content')
{!! Form::model($acceptingItem, ['route' => ['accepting-items.update', $acceptingItem->id], 'method' => 'PUT', 'id' => 'FormValidation', 'enctype' => 'multipart/form-data']) !!}
<div class="row">
    <div class="col">
      <div class="card p-3">
        <div class="card-body">
